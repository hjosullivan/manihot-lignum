...
//B: Bud()
 ...
 const ModuleIdType Turn_id = 7;
//Define the Start corresponding to the axiom
void Start()
{

  { Produce((ModuleIdType)(Fd_id));Produce((double)(LSEG));Produce((double)(RADIUS));Produce((double)(RADIUS_TOP));Produce((ModuleIdType)(Fd_id)); Produce((ModuleIdType)(SB_id)); Produce((ModuleIdType)(Pitch_id));Produce((double)(A45));Produce((ModuleIdType)(Pitch_id));Produce((ModuleIdType)(B_id));Produce((double)(2));Produce((ModuleIdType)(B_id));Produce((ModuleIdType)(EB_id)); Produce((ModuleIdType)(B_id));Produce((double)(1));Produce((ModuleIdType)(B_id));}
...
{
  if (go ==1)
    { Produce((ModuleIdType)(Fd_id));Produce((double)(LSEG));Produce((double)(RADIUS));Produce((double)(RADIUS_TOP));Produce((ModuleIdType)(Fd_id)); Produce((ModuleIdType)(Roll_id));Produce((double)(A90));Produce((ModuleIdType)(Roll_id)); Produce((ModuleIdType)(SB_id)); Produce((ModuleIdType)(Pitch_id));Produce((double)(A45));Produce((ModuleIdType)(Pitch_id));Produce((ModuleIdType)(B_id));Produce((double)(2));Produce((ModuleIdType)(B_id)); Produce((ModuleIdType)(EB_id)); Produce((ModuleIdType)(B_id));Produce((double)(go));Produce((ModuleIdType)(B_id));}
  else if (go==2){
     sign=-sign;
     { Produce((ModuleIdType)(Fd_id));Produce((double)(L020));Produce((double)(R2));Produce((double)(R2));Produce((ModuleIdType)(Fd_id)); Produce((ModuleIdType)(SB_id));Produce((ModuleIdType)(Turn_id));Produce((double)(sign*A45));Produce((ModuleIdType)(Turn_id));Produce((ModuleIdType)(B_id));Produce((double)(go+1));Produce((ModuleIdType)(B_id)); Produce((ModuleIdType)(EB_id)); Produce((ModuleIdType)(B_id));Produce((double)(go));Produce((ModuleIdType)(B_id));}
  }
  else 
    { Produce((ModuleIdType)(Fd_id));Produce((double)(L020));Produce((double)(RTHIN));Produce((double)(RTHIN_TOP));Produce((ModuleIdType)(Fd_id)); Produce((ModuleIdType)(SB_id)); Produce((ModuleIdType)(EB_id)); Produce((ModuleIdType)(B_id));Produce((double)(go));Produce((ModuleIdType)(B_id));}
