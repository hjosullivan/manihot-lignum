...
void Start()
{
  ...
  { Produce((ModuleIdType)(Fd_id));Produce((double)(LSEG));Produce((double)(RA1));Produce((double)(RA1));Produce((double)(A1));Produce((ModuleIdType)(Fd_id)); Produce((ModuleIdType)(SB_id)); Produce((ModuleIdType)(Pitch_id));Produce((double)(pitch1));Produce((ModuleIdType)(Pitch_id));  Produce((ModuleIdType)(B_id));Produce((double)(A2));Produce((double)(1));Produce((double)(1));Produce((double)(ALIVE));Produce((ModuleIdType)(B_id));Produce((ModuleIdType)(EB_id)); 
                              Produce((ModuleIdType)(SB_id)); Produce((ModuleIdType)(Roll_id));Produce((double)(PI_VALUE));Produce((ModuleIdType)(Roll_id)); Produce((ModuleIdType)(Pitch_id));Produce((double)(pitch2));Produce((ModuleIdType)(Pitch_id));  Produce((ModuleIdType)(B_id));Produce((double)(A2));Produce((double)(1));Produce((double)(1));Produce((double)(ALIVE));Produce((ModuleIdType)(B_id));Produce((ModuleIdType)(EB_id));
                                   Produce((ModuleIdType)(Roll_id));Produce((double)(PI_VALUE/2.0));Produce((ModuleIdType)(Roll_id)); Produce((ModuleIdType)(B_id));Produce((double)(A1));Produce((double)(1));Produce((double)(1));Produce((double)(ALIVE));Produce((ModuleIdType)(B_id));}
}


void _P1(double axis_type,double age,double phys_age,double status)
{
  double ran = u(1);
  double pitch1 = ba(MIN_PITCH,MAX_PITCH,u);
  double pitch2 = ba(MIN_PITCH,MAX_PITCH,u);
  { Produce((ModuleIdType)(Fd_id));Produce((double)(LSEG));Produce((double)(RA1));Produce((double)(RA1));Produce((double)(A1));Produce((ModuleIdType)(Fd_id)); Produce((ModuleIdType)(SB_id)); Produce((ModuleIdType)(Pitch_id));Produce((double)(pitch1));Produce((ModuleIdType)(Pitch_id));  Produce((ModuleIdType)(B_id));Produce((double)(A2));Produce((double)(1));Produce((double)(1));Produce((double)(ALIVE));Produce((ModuleIdType)(B_id));Produce((ModuleIdType)(EB_id)); 
                              Produce((ModuleIdType)(SB_id)); Produce((ModuleIdType)(Roll_id));Produce((double)(PI_VALUE));Produce((ModuleIdType)(Roll_id)); Produce((ModuleIdType)(Pitch_id));Produce((double)(pitch2));Produce((ModuleIdType)(Pitch_id));  Produce((ModuleIdType)(B_id));Produce((double)(A2));Produce((double)(1));Produce((double)(1));Produce((double)(ALIVE));Produce((ModuleIdType)(B_id));Produce((ModuleIdType)(EB_id));
                                   Produce((ModuleIdType)(Roll_id));Produce((double)(PI_VALUE/2.0));Produce((ModuleIdType)(Roll_id)); Produce((ModuleIdType)(B_id));Produce((double)(A1));Produce((double)(1));Produce((double)(1));Produce((double)(DEAD));Produce((ModuleIdType)(B_id));}
}


//Left hand and right hand context or Bud
    void _P2(double THICK,double c,double axis_type,double age,double phys_age,double status,double l1,double r1,double rtop1,double axis_type1)
{
if (THICK > 0.0)
...
_P2(p0,p1,p2,p3,p4,p5,p6,p7,p8,p9);
}
...
{ "B", sizeof(double)+sizeof(double)+sizeof(double)+sizeof(double)},
{ "Pitch", sizeof(double)},
{ "Turn", sizeof(double)},
{ "Roll", sizeof(double)},
{ "HRoll",  0 },
